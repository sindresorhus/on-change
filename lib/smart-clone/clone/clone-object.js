...
const {MUTABLE_ARRAY_METHODS} = require('../methods/array');
const {MUTABLE_SET_METHODS} = require('../methods/set');
const {MUTABLE_MAP_METHODS} = require('../methods/map');
const {IMMUTABLE_OBJECT_METHODS} = require('../methods/object');
