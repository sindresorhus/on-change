...
const CloneObject = require('./clone/clone-object');
const CloneArray = require('./clone/clone-array');
const CloneDate = require('./clone/clone-date');
const CloneSet = require('./clone/clone-set');
const CloneMap = require('./clone/clone-map');
const CloneWeakSet = require('./clone/clone-weakset');
const CloneWeakMap = require('./clone/clone-weakmap');
